...
const Product = () => {
    return (
        <div className="bg-primary -m-4 py-10">
            <h1 className="text-2xl font-bold tracking-wide text-white uppercase text-center mb-20">Our Product</h1>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-900 to-purple-900 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
                <div className="relative bg-white shadow-lg sm:rounded-3xl p-5">
                    <div className="mx-5">
                    <div>
                        <img src={productImage} className="" alt="products"/>
                    </div>
            ...
            <h4 className="text-xl font-bold text-white uppercase text-center mt-20">Includes</h4>
